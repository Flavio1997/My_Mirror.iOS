...
[assembly: ExportRenderer(typeof(PaginaFotocamera), typeof(CameraPageRenderer))]
namespace CustomRenderer.iOS
{
    public class CameraPageRenderer : PageRenderer
    {
        ...
        void SetupUserInterface()
        {
            ...
            if (idiom.ToString() == "Pad")
            {
                liveCameraStream = new UIView()
                {
                    Frame = new CGRect(0f, 0f, View.Bounds.Width, View.Bounds.Height + 100)
                };
            }
            else
            {
        ...
        void SetupLiveCameraStream()
        {
            ...
            ToggleFrontBackCamera();    //Gira Sufotocamera Frontale
        }
